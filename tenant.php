...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['create']) && $_POST['create'] == "create"){
    ...
    if($err == 0 && $_SESSION['nonce'] == $_POST['nonce']){
        $agent = new Tenant();
        $agent->setTenName($name);
        $agent->setTenIdNo($idNo);
        $agent->setTenEmail($email);
        $agent->setTenPhone($phone);
        $msgs = $agent->createTenant();
    }else{
...
?>
    ...
    <div class="container">
        ...
        <div class="row" id="box">
            <?php include 'gui/tenant_new_form.php' ?>
            <div class="span12">
                ...
                <div class="row">
                    <div class="span12">
                        ...
                        <table class="table table-condensed table-hover">
                            ...
                            <?php
                            $em = $system->getDatabaseManager();
                            $entities = $em->getRawEntity('tenant');
                            ...
                            while($entity = $em->fetch($entities)){ ?>
                                <tr>
                                    ...
                                    <td class="span2"><?php echo $entity['ten_name']?></td>
                                    <td class="span2"><?php echo $entity['ten_idno']?></td>
                                    <td class="span2"><?php echo $entity['ten_phone']?></td>
                                    <td class="span2"><?php echo $entity['ten_email'] ?></td>
                                    <td class="span2"><a class="btn btn-primary"
                                                         href="edit.php?table=tenant&id=<?php echo $entity['id'] ?>">
